...
export interface FlowbiteSidebarToggleTheme extends FlowbiteBaseButtonTheme {
  host: FlowbiteSidebarToggleHostTheme;
}

export interface FlowbiteSidebarToggleHostTheme extends FlowbiteBaseButtonHostTheme {
  base: string;
}
