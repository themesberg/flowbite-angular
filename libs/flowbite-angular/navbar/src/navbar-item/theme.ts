...
export const flowbiteNavbarItemTheme: FlowbiteNavbarItemTheme = createTheme({
  host: {
    ...
    color: {
      info: 'text-gray-900 data-focus-visible:ring-blue-400 data-hover:text-blue-700 dark:text-gray-100 dark:data-focus-visible:ring-blue-600',
      failure:
        'text-gray-900 data-focus-visible:ring-red-400 data-hover:text-red-700 dark:text-gray-100 dark:data-focus-visible:ring-red-600',
      success:
        'text-gray-900 data-focus-visible:ring-green-400 data-hover:text-green-700 dark:text-gray-100 dark:data-focus-visible:ring-green-600',
      warning:
        'text-gray-900 data-focus-visible:ring-yellow-400 data-hover:text-yellow-700 dark:text-gray-100 dark:data-focus-visible:ring-yellow-600',
      primary:
        'data-hover:text-primary-700 data-focus-visible:ring-primary-400 dark:data-focus-visible:ring-primary-600 text-gray-900 dark:text-gray-100',
      dark: 'text-gray-900 data-focus-visible:ring-gray-300 data-hover:text-gray-900 dark:text-gray-100 dark:data-focus-visible:ring-gray-800',
      light:
        'text-gray-900 data-focus-visible:ring-gray-100 data-hover:text-gray-900 dark:text-gray-100 dark:data-focus-visible:ring-gray-600',
      blue: 'text-gray-900 data-focus-visible:ring-blue-400 data-hover:text-blue-700 dark:text-gray-100 dark:data-focus-visible:ring-blue-600',
      ...
      gray: 'text-gray-900 data-focus-visible:ring-gray-400 data-hover:text-gray-700 dark:text-gray-100 dark:data-focus-visible:ring-gray-600',
      green:
        'text-gray-900 data-focus-visible:ring-green-400 data-hover:text-green-700 dark:text-gray-100 dark:data-focus-visible:ring-green-600',
      indigo:
      ...
      purple:
        'text-gray-900 data-focus-visible:ring-purple-400 data-hover:text-purple-800 dark:text-gray-100 dark:data-focus-visible:ring-purple-600',
