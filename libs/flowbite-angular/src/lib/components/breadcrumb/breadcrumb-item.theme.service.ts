...
import type { BreadcrumbItemBaseTheme, BreadcrumbItemClass, BreadcrumbItemProperties } from './breadcrumb-item.theme';

import { inject, InjectionToken } from '@angular/core';
import { twMerge } from 'tailwind-merge';

export const FLOWBITE_BREADCRUMB_ITEM_THEME_TOKEN = new InjectionToken<BreadcrumbItemBaseTheme>(
