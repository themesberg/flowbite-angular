...
export const FLOWBITE_DROPDOWN_DIVIDER_THEME_TOKEN = new InjectionToken<DropdownDividerBaseTheme>(
...
export class DropdownDividerThemeService implements FlowbiteThemeService<DropdownDividerProperties> {
  ...
  public getClasses(properties: DropdownDividerProperties): DropdownDividerClass {
    const theme: DropdownDividerBaseTheme = mergeTheme(this.baseTheme, properties.customStyle);
