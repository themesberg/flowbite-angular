...
import type { NavbarContentBaseTheme, NavbarContentClass, NavbarContentProperties } from './navbar-content.theme';

import { inject, InjectionToken } from '@angular/core';
import { twMerge } from 'tailwind-merge';

export const FLOWBITE_NAVBAR_CONTENT_THEME_TOKEN = new InjectionToken<NavbarContentBaseTheme>(
...
export class NavbarContentThemeService implements FlowbiteThemeService<NavbarContentProperties> {
  ...
  public getClasses(properties: NavbarContentProperties): NavbarContentClass {
    const theme: NavbarContentBaseTheme = mergeTheme(this.baseTheme, properties.customStyle);
